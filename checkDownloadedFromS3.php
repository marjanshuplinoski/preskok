...
function checkDownloadedFromS3($uploadToS3Cloud = null)
{
    ...
    $notFoundInS3CloudList = CompareLocalAndS3Folders($localFolders, $s3FolderList,1);
    if (!isset($uploadToS3Cloud))
        return getFolderAndFilesPreview($notFoundInS3CloudList,1);
    else
        return $notFoundInS3CloudList;
}


function CompareLocalAndS3Folders($localFolderList, $s3FolderList, $downloaded = null)
{
